...
class TritonHCUGPUReorderInstructionsPass
    : public TritonHCUGPUReorderInstructionsBase<
          TritonHCUGPUReorderInstructionsPass> {
public:
  TritonHCUGPUReorderInstructionsPass() = default;
...
std::unique_ptr<Pass> mlir::createTritonHCUGPUReorderInstructionsPass() {
  return std::make_unique<TritonHCUGPUReorderInstructionsPass>();
}
