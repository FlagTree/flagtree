...
from triton.backend_interface import GeneralBackend
...
class IluvatarBackend(GeneralBackend):
    @staticmethod
    ...
    class AttrsDescriptor:
        ...
        @staticmethod
        def from_dict(data):
            return IluvatarBackend().AttrsDescriptor(divisible_by_16=set(data.get('divisible_by_16',
