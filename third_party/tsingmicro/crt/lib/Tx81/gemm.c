...
void __Gemm(int64_t* srcA, int64_t *srcB, int64_t * srcBias, int64_t *zeros,
    int64_t *dims, bool enPsum, int64_t *psum, bool enTransA, bool enTransB,
    int64_t batchSizeA, int64_t batchSizeB, bool enLeakyRelu, bool enBias,
    bool enNegScale, int64_t *negScale, bool enPosScale, int64_t *posScale,
    int64_t srcFmt, int64_t dstFmt, int64_t* dst)
{
