...
// https://github.com/google/heir/blob/main/lib/Transforms/ForwardStoreToLoad
// License: Apache 2.0
// Modifications:remove affine related codes
...
LogicalResult
ForwardSingleStoreToLoad::matchAndRewrite(memref::LoadOp loadOp,
...
LogicalResult
RemoveUnusedStore::matchAndRewrite(memref::StoreOp storeOp,
                                   PatternRewriter &rewriter) const {
