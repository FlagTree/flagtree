...
// https://mlir.llvm.org/doxygen/FlattenMemRefs_8cpp_source.html
// License: Apache 2.0
...
template <typename T> static ValueRange getIndices(T op) {
...
template <typename T> struct MemRefRewritePattern : public OpRewritePattern<T> {
...
struct FlattenMemrefsPass
    : public mlir::aipu::impl::FlattenMemrefsPassBase<FlattenMemrefsPass> {
  using Base::Base;
  ...
  void runOnOperation() override {
    ...
    populateFlattenMemrefsPatterns(patterns);
