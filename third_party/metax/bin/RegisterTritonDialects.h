...
BackendRegisterFunc load_backend_register_func(const char *backend_name, const char *func_name) {
...
DialectRegisterFunc load_dialect_register_func(const char *backend_name, const char *func_name) {
  void *symbol = load_backend_symbol(backend_name, func_name);
...
inline void registerTritonDialects(mlir::DialectRegistry &registry) {
  ...
  auto registerAllTritonPasses = load_backend_register_func("metax", "registerAllTritonPasses");
