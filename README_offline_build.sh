...
echo ""
echo "  2. Use the script to download. The default to store the downloaded files is ~/.flagtree-offline-download,"
echo "     you can specify the directory the store the downloaded files into: (default: ~/.flagtree-offline-download)"
echo "       # Default"
echo "          $ sh ./offline_build_download.sh"
echo "       # Specify directory to store downloaded files"
echo "          $ sh ./offline_build_download.sh <YOUR_DOWNLOAD_DIR>"
echo ""
echo ">>>>> Second, run the script to pack the dependencies into a .zip file. You can specify the source directory"
echo "      providing the downloaded files. (default: ~/.flagtree-offline-download)"
echo "       # Default"
echo "          $ sh utils/offline_build_pack.sh"
echo "       # Specify the input directory"
echo "          $ sh utils/offline_build_pack.sh <YOUR_DOWNLOAD_DIR>"
echo ""
...
echo "      unpacked dependencies. (default: ~/.flagtree-offline-build)"
echo "       # Default"
echo "          $ sh utils/offline_build_unpack.sh"
echo "       # Specify the input & output directory"
echo "          $ sh utils/offline_build_unpack.sh <YOUR_UNPACK_DIR>"
echo ""
...
echo "          $ export FLAGTREE_OFFLINE_BUILD_DIR=<UNPACK_DIR>"
echo ""
echo " =============================================="