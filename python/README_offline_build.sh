...
echo -e "      (TRITON_ASCEND is only for TRITON_BACKEND = ascend):"
echo -e "      TRITON_ASCEND should be downloaded from ${BLUE}https://gitee.com/ascend/triton-ascend/repository/archive/master.zip${NC}"
echo -e "          and stored as: <YOUR_DOWNLOAD_DIR>/trtion-ascend-master.zip"
echo -e "      ASCENDNPU IR for TRITON_ASCEND should be downloaded from ${BLUE}https://gitee.com/ascend/ascendnpu-ir/repository/archive/1922371c42749fda534d6395b7ed828b5c9f36d4.zip${NC}"
echo -e "          and stored as: <YOUR_DOWNLOAD_DIR>/ascendnpu-ir-1922371c42749fda534d6395b7ed828b5c9f36d4.zip"
echo -e "      TRITON for TRITON_ASCEND should be downloaded from ${BLUE}https://github.com/triton-lang/triton/archive/9641643da6c52000c807b5eeed05edaec4402a67.zip${NC}"
echo -e "          and stored as: <YOUR_DOWNLOAD_DIR>/triton-9641643da6c52000c807b5eeed05edaec4402a67.zip"
