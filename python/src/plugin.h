...
static void *load_backend_plugin(const char *backend_name) {
  ...
  const std::string &plugin_path =
      get_env("FLAGTREE_BACKEND_PLUGIN_LIB_DIR").value_or(lib_name) +
      get_env("FLAGTREE_BACKEND").value_or("") + "TritonPlugin.so";
